 ...
 * @author Ngoc Lan
 */
@WebServlet(name="LoadThietBiChung", urlPatterns={"/loadthietbichung"})
public class LoadThietBiChung extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("EditThietBiChung.jsp").forward(request, response);
    }
