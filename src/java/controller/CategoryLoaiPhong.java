 ...
 * @author vulin
 */
@WebServlet(name = "CategoryLoaiPhong", urlPatterns = {"/categoryloaiphong"})
public class CategoryLoaiPhong extends HttpServlet {
...
HttpSession session = request.getSession();
        ...
        List<Phong> listc = u.getPhongByLoaiPhong(bl); //edit
