    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (hoaDon != null) {
            ...
            try {
                ...
                PdfPCell cell3 = new PdfPCell(new Phrase("Mã hợp đồng:", contentFont));
                cell3.setBackgroundColor(BaseColor.LIGHT_GRAY);
                cell3.setPadding(10f);
                table.addCell(cell3);

                PdfPCell cell4 = new PdfPCell(new Phrase(String.valueOf(hoaDon.getHopDongID()), utf8Font));
                cell4.setPadding(10f);
                table.addCell(cell4);

                PdfPCell cell5 = new PdfPCell(new Phrase("Ngày thanh toán:", contentFont));
                cell5.setBackgroundColor(BaseColor.LIGHT_GRAY);
                cell5.setPadding(10f);
                table.addCell(cell5);

                PdfPCell cell6 = new PdfPCell(new Phrase(String.valueOf(hoaDon.getNgayThanhToan()), utf8Font));
                cell6.setPadding(10f);
                table.addCell(cell6);

                PdfPCell cell7 = new PdfPCell(new Phrase("Tình trạng:", contentFont));
                cell7.setBackgroundColor(BaseColor.LIGHT_GRAY);
                cell7.setPadding(10f);
                table.addCell(cell7);

                PdfPCell cell8 = new PdfPCell(new Phrase(hoaDon.getTinhTrangThanhToan(), utf8Font));
                cell8.setPadding(10f);
                table.addCell(cell8);

                PdfPCell cell9 = new PdfPCell(new Phrase("Từ ngày:", contentFont));
                cell9.setBackgroundColor(BaseColor.LIGHT_GRAY);
                cell9.setPadding(10f);
                table.addCell(cell9);

                PdfPCell cell10 = new PdfPCell(new Phrase(String.valueOf(hoaDon.getTuNgay()), utf8Font));
                cell10.setPadding(10f);
                table.addCell(cell10);

                PdfPCell cell11 = new PdfPCell(new Phrase("Đến ngày:", contentFont));
                cell11.setBackgroundColor(BaseColor.LIGHT_GRAY);
                cell11.setPadding(10f);
                table.addCell(cell11);

                PdfPCell cell12 = new PdfPCell(new Phrase(String.valueOf(hoaDon.getDenNgay()), utf8Font));
                cell12.setPadding(10f);
                table.addCell(cell12);

                PdfPCell cell13 = new PdfPCell(new Phrase("Tổng tiền:", contentFont));
                cell13.setBackgroundColor(BaseColor.LIGHT_GRAY);
                cell13.setPadding(10f);
                table.addCell(cell13);

                PdfPCell cell14 = new PdfPCell(new Phrase(String.valueOf(hoaDon.getTongTien()), utf8Font));
