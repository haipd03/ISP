 ...
 * @author vulin
 */
@WebServlet(name = "CategoryTinhTrang", urlPatterns = {"/categorytinhtrang"})
public class CategoryTinhTrang extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Phong> listc = u.getPhongByTinhTrang(bt); //edit
