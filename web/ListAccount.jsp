                                        ...
                                        <c:forEach items="${listA}" var="o">
                                            ...
                                            <tr class="bg-white border-b">
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 text-sm">
                                                    ...
                                                    <a href='deleteacc?aid=${o.accountID}' class="text-red-600 hover:text-red-900 ml-2">Delete</a>
                                                </td>
                                            </tr>
...
<!--                                    <div class="flex items-center">
                                        ...
                                        <input type="text" name="role" class="w-2/3 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400">
                                    </div>-->
                                    <div class="flex items-center">
