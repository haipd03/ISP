                ...
                <div class="flex flex-1">
                    ...
                    <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                        ...
                        <div class="flex flex-col">
                            ...
                            <form class="searchform cf flex justify-center items-center mt-4 mb-4">
                                <input type="text" placeholder="Is it me you’re looking for?" class="w-full md:w-3/4 lg:w-1/2 p-4 border border-gray-600 rounded-l-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-r-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    Search
                                </button>
                            </form>
                            ...
                            <table border="0">
                                <tbody>
                                    <tr>
                                        <td><h1>List </h1></td>
                                        <td><div class="container1"><form action="nhapaddphong" method="post" >
                                                    <input type="submit" class="add-button" ></button>
                                                </form></div>
                                        </td>
                                    </tr>
                                </tbody>
