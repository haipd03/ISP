    ...
    <div class="mx-auto bg-grey-lightest">
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <div class="flex flex-1">
                ...
                <div class="p-4">
                    <h4 class="text-lg font-semibold mb-2">Danh sách dịch vụ:</h4>
                            ...
                            <tbody>
                                <c:forEach items="${ldv}" var="o">
                                    <tr class="transition-colors hover:bg-gray-100">
                                        <td class="px-4 py-2">${o.dichVuID}</td>
                                        ...
                                        <td class="px-4 py-2">${o.chiSoCu}</td>
                                        <td class="px-4 py-2">${o.chiSoMoi}</td>
                                        <td class="px-4 py-2">
