if  exists  (select name from sys.databases where name='DbTro' ) 
...
insert into KhachThue values(1011,N'Phan Đức Hải','001126484354','0254896354',N'Bắc Ninh',N'Phan Đức Quân','0903456789',N'Bố',1001)
insert into KhachThue values(1012,N'PhanThanh Sơn','001226594873','0354896575',N'Phú Yên',N'Phan Văn Hải','0912345678',N'Bố',1002)
insert into KhachThue values(1013,N'Vũ Thị Kiều Linh','001132369854','0954875216',N'Hà Nội ',N'Vũ Mạnh Khởi','0934567890',N'Chú',1004)
insert into KhachThue values(1014,N'Nguyễn Tiến Đạt','001369854724','0358964758',N'Bắc Giang',N'Nguyễn Minh Hoàng','0987654321',N'Anh',1004)
insert into KhachThue values(1015,N'Trần Thị Ngọc Lan','001369584214','0365874951',N'Lào Cai',N'Trần Quốc Việt','0902123456',N'Bố',1009)
insert into KhachThue values(1016,N'Trần Quang Trường','001356987425','0954875236',N'Nghệ An',N'Nguyễn Thị Hiền','0978123456',N'Bà',1009)
insert into KhachThue values(1017,N'Trần Mạnh Dũng','001254789650','0912400948',N'Hà Nội ',N'Trần Kim Liên','0911234567',N'Mẹ',1009)
insert into KhachThue values(1018,N'Nguyễn Phương Nam','001254876312','0368549101',N'Hà Nội ',N'Bùi Minh Phương','0965432109',N'Mẹ',1010)
insert into KhachThue values(1019,N'Lê Thị Linh','001201453658','0912458888',N'Vĩnh Phúc',N'Vũ Hoài Nam','0933222111',N'Bố',1010)
insert into KhachThue values(1020,N'Trịnh Minh Hiếu','001250154864','0969876543',N'Phú Thọ',N'Trịnh Minh Vũ','0921987654',N'Bố',1010)
insert into KhachThue values(1021,N'Nguyễn Tuấn Đạt','001874362793','0928765432',N'Thái Bình',N'Nguyễn Thị Lý','0986543210',N'Mẹ',2012)
insert into KhachThue values(1022,N'Nguyễn Hữu Huy','001093874625','0931987654',N'Hà Nam',N'Lê Thùy Linh','0905678912',N'Mẹ',2012)
insert into KhachThue values(1023,N'Trần Khánh Ly','001346735732','0917654321',N'Nam Định',N'Trần Mai Loan','0919876543',N'Mẹ',2016)
insert into KhachThue values(1024,N'Vũ Đức Mạnh','001365825524','0974321098',N'Hà Nội',N'Vũ Ngọc Linh','0932456789',N'Mẹ',2016)
insert into KhachThue values(1025,N'Nguyễn Thu Hoài','001236568378','0906543210',N'Quảng Ninh',N'Nguyễn Mạnh Tiến','0972345678',N'Bố',2017)
insert into KhachThue values(1026,N'Nguyễn Hương Giang','001235547324','0981234567',N'Thái Nguyên',N'Nguyễn Tuấn Đạt','0983456789',N'Bố',2017)
insert into KhachThue values(1027,N'Chạc Trường Lộc','001623143523','0936789012',N'Bạc Liêu',N'Vũ Khánh Ly','0945678123',N'Mẹ',2017)
insert into KhachThue values(1028,N'Nông Đức Đại','001354572455','0913456789',N'Bắc Ninh',N'Trần Thị Giang','0967543210',N'Mẹ',2019)
insert into KhachThue values(1029,N'Phạm Long Vũ','001354572456','0908123456',N'Hà Giang ',N'Bùi Thị Hạnh','0939876543',N'Mẹ',2019)
insert into KhachThue values(1030,N'Nguyễn Hà Mi','001354572457','0971234567',N'Hà Nội',N'Nguyễn Phúc Thọ','0971234567',N'Bố',2019)
...
insert into HopDong(HopDongID,KhachID,PhongID,TienCoc,NgayThue,NgayTra,SoKhachThue,CCCD,SDT,HoVaTen) values(04,1015,1009,2000000,'2024-01-04','2024-06-01',3,'001369854724','0358964758',N'Nguyễn Tiến Đạt')
insert into HopDong(HopDongID,KhachID,PhongID,TienCoc,NgayThue,NgayTra,SoKhachThue,CCCD,SDT,HoVaTen) values(05,1018,1010,2000000,'2024-01-05','2024-03-01',3,'001369584214','0365874951',N'Trần Thị Ngọc Lan')
insert into HopDong(HopDongID,KhachID,PhongID,TienCoc,NgayThue,NgayTra,SoKhachThue,CCCD,SDT,HoVaTen) values(06,1021,2012,1500000,'2024-01-06','2025-01-01',2,'001356987425','0954875236',N'Trần Quang Trường')
insert into HopDong(HopDongID,KhachID,PhongID,TienCoc,NgayThue,NgayTra,SoKhachThue,CCCD,SDT,HoVaTen) values(07,1023,2016,2000000,'2024-01-07','2025-01-01',2,'001254789650','0912400948',N'Trần Mạnh Dũng')
insert into HopDong(HopDongID,KhachID,PhongID,TienCoc,NgayThue,NgayTra,SoKhachThue,CCCD,SDT,HoVaTen) values(08,1025,2017,2000000,'2024-01-08','2024-03-01',3,'001254876312','0368549101',N'Nguyễn Phương Nam')
insert into HopDong(HopDongID,KhachID,PhongID,TienCoc,NgayThue,NgayTra,SoKhachThue,CCCD,SDT,HoVaTen) values(09,1028,2019,2000000,'2024-01-09','2024-06-01',3,'001201453658','0912458888',N'Lê Thị Linh')
